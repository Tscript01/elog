...
var auth_global_default = defineNuxtRouteMiddleware(async (to) => {
	...
	try {
		...
		if (!decoded.exp || decoded.exp <= currentTime) isExpired = true;
		else role = decoded.role ? String(decoded.role).toLowerCase() : null;
	} catch {
		isExpired = true;
	}
	if (isExpired || !role) {
	...
	if (isPublicRoute || to.path === "/") {
		...
		if (returnTarget && returnTarget !== "/login" && returnTarget !== "/signup" && returnTarget !== "/" && returnTarget.startsWith(`/${role}`) && to.fullPath !== returnTarget) return navigateTo(returnTarget);
		if (to.path !== targetLanding) return navigateTo(targetLanding);
		return;
	}
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		meta: { layout: "student" },
		component: () => import('../build/dashboard-DdpitvVX.mjs')
	},
	{
		name: "student-logs",
		path: "/student/logs",
		meta: { layout: "student" },
		component: () => import('../build/logs-CBXgDEM3.mjs')
	},
	{
		name: "student-placement",
		path: "/student/placement",
		meta: { layout: "student" },
		component: () => import('../build/placement-BbY0MWDK.mjs')
	},
	{
		name: "student-viewlogs",
		path: "/student/viewlogs",
		meta: { layout: "student" },
		component: () => import('../build/viewlogs-bYxGqUmO.mjs')
	},
	{
		name: "login",
		path: "/login",
		meta: { layout: false },
		component: () => import('../build/login-Ra1j0vkm.mjs')
	},
	{
		name: "index",
		path: "/",
		meta: { layout: false },
		component: () => import('../build/pages-B3YjdZOF.mjs')
	}
];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { student: defineAsyncComponent(() => import('../build/student-BLlDVSeQ.mjs').then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-Dr_lIFc0.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-CjbrQ05I.mjs'));
...
export { $fetch$2 as $, _plugin_vue_export_helper_default as _, useCookie as a, useRoute$1 as b, useHead$1 as c, useRouter as d, encodeRoutePath as e, useNuxtApp as f, nuxtLinkDefaults as g, entry as h, navigateTo as n, resolveRouteObject as r, useRuntimeConfig as u };
